...
---@field line_height? number must be greater than 0
---@field cell_width? number default = "default_one_point_oh_f64"
...
---https://wezterm.org/config/lua/config/canonicalize_pasted_newlines.html?h=canonicalize_pasted_newlines
...
local WeztermConfig = {
	...
	---@type number? default = "default_one_point_oh_f64"
	cell_width = 1.0,

	---@type Dimension? specified by underline_thickness
	cursor_thickess = 2.0,

	---@type Dimension? specified by font
	...
	---@type "Allow" | "Never" | "WhenFollowedBySpace" | nil
	...
	---@type IntegratedTitleButtonStyle? default is MacOsNative no Mac, Windows on all others
	integrated_title_button_style = "Windows",

	---@type "Auto" | string | nil Auto or custom color like "red"
