...
mh.name = "MenuHammer"
mh.version = "0.3"
mh.author = "Based largely on work by FryJay <darin.j.fry@gmail.com>"
mh.originalRepo = "https://github.com/FryJay/MenuHammer"
...
local menuCustomConfig = hs.fs.pathToAbsolute(hs.configdir .. "/menuHammerCustomConfig.lua")
...
function mh:init()
	...
	mh.menuManager =
		MenuManager.new(menuHammerToggleKey, menuHammerMenuList, menuItemColors, menuItemPrefix, showMenuBarItem)
