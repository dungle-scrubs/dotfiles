...
local function getSortedResolutionKeys(resolutions)
	local function sortResolutions(resolutionA, resolutionB)
		local prefixA = tonumber(string.sub(resolutionA, 1, string.find(resolutionA, "x") - 1))
		local prefixB = tonumber(string.sub(resolutionB, 1, string.find(resolutionB, "x") - 1))
